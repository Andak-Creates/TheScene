    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
          ...
          <div style={{ padding: "24px" }}>
            ...
            >
              {[
                {
                  label: "Date",
                  value: formatDate(party.date, party.date_tba),
                },
                {
                  label: "Location",
                  value:
                    [party.location, party.city].filter(Boolean).join(", ") ||
                    "TBA",
                },
                { label: "Ticket Type", value: tier?.name ?? "General" },
                {
                  label: "Quantity",
                  value: `${ticket.quantity_purchased} ticket${ticket.quantity_purchased > 1 ? "s" : ""}`,
                },
                ...
                <div key={label}>
                  ...
                  <p
                    style={{
                      margin: 0,
                      color:
                        label === "Status" && !usedAll ? "#4ade80" : "#fff",
                      fontWeight: 600,
                      fontSize: 14,
                      lineHeight: 1.3,
                    }}
        ...
        >
          ...
          >
            Discover more events, follow hosts, and manage your tickets
          </p>
